      ...
      >
        ...
        >
          ...
          <div className="pe-3 col-8 col-lg-9 ">
            ...
            <p className="fs-6">
              من زهرا رجبی رتبه ۱۰ کنکور ریاضی و کارشناسی ارشد روانشناسی با
              گرایش شخصیت هستم
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="pe-3 col-8 col-lg-9 ">
            ...
            <p className="fs-6">
              تخصص ام در زمینه افزایش هوش ، تمرکز ، حافظه و درمان بیش فعالی می
              باشد و در این زمینه پژوهش و فعالیت عملی زیادی در کلینیک های
              روانشناسی داشته ام .
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="pe-3 col-8 col-lg-9 ">
            ...
            <p className="fs-6">
              دوره های تخصصی استعدادیابی را از انجمن استعدادیابی ایران، دوره های
              تحصصی کم توجهی و درمان بیش فعالی را از مرکز تخصصی خدمات روان
              شناختی مشاوره آریاز کسب نموده ام
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="pe-3 col-8 col-lg-9 ">
            ...
            <p className="fs-6">
              برنامه‌ها و خدماتم براساس ساختار مغز طراحی و تنظیم شده است، درس
              خواندن را با ساختار مغز تجربه کنید و ازآن لذت ببرید
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="row d-flex justify-content-evenly justify-content-lg-center servis-main">
              ...
              >
                <div className="servis-item">
                  ...
                  <p>
                    نقسه راه یک استراتژی است برای اینکه از انرژی ، هوش و توانایی
                    شما بهتر استفاده شود و به شما بگوید چکار کنید و چه درسی را
                    چقدر و چگونه بخوانید که بتوانید به رشته دلخواه خود برسید
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="servis-item">
                  ...
                  <p>
                    به تعداد دانش آموزان روش موثربرای مطالعه وجود دارد مهمترین
                    کار یک مشاور تحصیلی بتواند روشی که شما بهتر مطالب را یاد
                    میگیرید را پیدا کند و در جهت بهبود آن کوشا باشد.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="servis-item">
                  ...
                  <p>
                    استعدادیابی نقطه اتلاق هوش ، شخصیت و علاقه مندی است. از
                    تحلیل سه آزمون هوش،شخصیت و علاقه مندی شما ، رسالت شما که در
                    آن نابغه هستید را پیدا میکنیم . . بهمراه یک جلسه مشاوره
                    تلفنی و نقشه راه رایگان .
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="servis-item">
                  ...
                  <p>
                    کارنامه شما را بررسی میکنید با توجه به استعدادتون بهتان
                    راهکار میدهیم که چکار کنید تا معدلتون بهتر شود . و کتاب های
                    کمکی مناسب به شما پیشنهاد میشود .
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="servis-item">
                  ...
                  <p>
                    این نوع برنامه ریزی را اولین بار در کشور استرالیا برای آموزش
                    زبان افراد غیر بومی دیدم و نتیجه اش باور نکردنی بود. افراد
                    با انگیزه بالاتری مطالعه میکردند و هرروز مشتاق تربودندبرای
                    مطالعه چون برنامه فردا را نمی‌دونستند
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="footer d-none d-flex justify-content-around flex-column align-items-center">
          ...
          <div className="footer-wrapper ">
            <a
              ...
              href="https://eitaa.com/joinchat/4029219512C146299db8d"
            >
            ...
            <a
              className="footer-button text-dark text-decoration-none"
              href="https://rubika.ir/Zahraarajabii"
            >
              <div className="footer-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <a
              className="footer-button text-dark text-decoration-none"
              href="https://wa.me/message/QG6P3QSVMOXFL1"
            >
              <div className="footer-icon">
